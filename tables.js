...
db.query('CREATE TABLE IF NOT EXISTS admin (user INT(11) NOT NULL, date_entered DATETIME DEFAULT CURRENT_TIMESTAMP)', function(err, results){
	if (err) throw err;
...
var user = 1;
db.query('INSERT INTO admin (user) VALUES (?)', [user], function(err, results){
	if (err) throw err;
